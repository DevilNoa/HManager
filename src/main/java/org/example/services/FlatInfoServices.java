...
public class FlatInfoServices {
  ...
  public List<FlatInfo> getAllFlatsByBuildingAndFlatNum(String buildingName, int apartmentNumber)
      throws SQLException {
  ...
  // Update a Flat
  public FlatInfo updateFlat(String buildingName, int flatNumber, FlatInfo updatedFlat)
      throws SQLException {
