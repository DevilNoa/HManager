...
public class FlatInfoResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAllFlatsByBuildingAndFlatNum(@PathParam("buildingName") String buildingName, @PathParam("apartmentNumber") int apartmentNumber) {
        try{
            List<FlatInfo> flatInfos = flatInfoServices.getAllFlatsByBuildingAndFlatNum(buildingName, apartmentNumber);
            return Response.ok(flatInfos).build();
        }catch (SQLException e){
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR).build();
        }
    ...
    public Response deleteFlat(@PathParam("buildingName") String buildingName, @PathParam("apartmentNumber") int apartmentNumber) {
        try {
